            ...
            <div class="row" style="width:100%; height:100%; align-items: center; justify-content:center;">
                ...
                <div class="col-4">
                    <table cellpadding="50" cellspacing="100" style="width:100%">
                        <form action="IsLoginadmin.php" method="POST" id="loginForm" novalidate>
                            <tr>
                                <td>
                                    <h1 style="margin-bottom:20px">Admin Login</h3>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <input type="submit" value="Admin Login" style="background-color:black; color:white; padding-left:15px; padding-right:15px; border-radius:20px; font-size:15px; margin-top:10px; margin-bottom:10px">
                                </td>
                            </tr>
                        </form>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <form action="login.php" method="post">
                                    <input type="submit" value="Login" title="Login" style="background-color:black; color:white; padding-left:15px; padding-right:15px; border-radius:20px; font-size:15px; margin-top:10px; margin-bottom:10px">
                                </form>
                            </td>
                        </tr>
                        <tr>

...
<body style="background-color:white">
    <header class="header-part" style="background-color:white">
        <div class="container">
            <div class="header-left" style="margin-left:-368px;">
    ...
    <section class="promo-part" style="background-color:white; text-align:center; align-items: center; justify-content:center;">
        <div class="container" style="text-align:center; font-size:25px; font-weight:bold; width:100vw; height:90vh; display:flex;align-items: center; justify-content: center; flex-direction: column;">
            <div class="row" style="width:100%; height:100%; align-items: center; justify-content:center;">
                <div class="col-4"></div>
                <div class="col-4">
                    <form action="customer_reg.php" method="POST" id="loginForm" novalidate>
                        <table cellpadding="50" cellspacing="100" style="width:100%">
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="fname" placeholder="First Name" style="border-radius:2px;border:solid 1px; padding-left:5px; padding-bottom:7px; box-shadow:3px 5px 1px 1px gray; font-size:16px; width:100%; margin-top:10px; margin-bottom:10px">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="text" id="lname" name="lname" placeholder="Last Name" style="border-radius:2px;border:solid 1px; padding-left:5px; padding-bottom:7px; box-shadow:3px 5px 1px 1px gray; font-size:16px; width:100%; margin-top:10px; margin-bottom:10px">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="text" id="email" name="email" placeholder="Email" style="border-radius:2px;border:solid 1px; padding-left:5px; padding-bottom:7px; box-shadow:3px 5px 1px 1px gray; font-size:16px; width:100%; margin-top:10px; margin-bottom:10px">
                            ...
                            <tr>
                                <td>
                                    <input type="password" id="repass" name="repass" placeholder="Repeat Password" style="border-radius:2px;border:solid 1px; padding-left:5px; padding-bottom:7px; box-shadow:3px 5px 1px 1px gray; font-size:16px; width:100%; margin-top:10px; margin-bottom:10px">
                            ...
                            <tr>
                                <td>
                                    <input type="submit" value="Create" name="Register" style="background-color:black; color:white; padding-left:15px; padding-right:15px; border-radius:20px; font-size:15px; margin-top:10px; margin-bottom:10px">
                                </td>
                            </tr>
                            <tr>
                                <td>
